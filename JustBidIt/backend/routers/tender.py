# =============================================================
#  routers/tender.py — Tender Upload, Extraction & Listing
# =============================================================
...
async def upload_tender(
    ...
    # ── Create initial DB record (status: pending) ──
    ...
    if "error" in extracted:
        # Partial success: we have the raw text but AI extraction failed
        tender.status        = "failed"
