...
async function doGenerateDraft() {
  ...
  card.innerHTML = `
    <div class="card-body" style="text-align:center; padding:56px 40px;">
      ...
      <p style="color:var(--text-2);font-size:0.84rem;">Llama 3.3 70B is composing all 9 sections — please wait</p>
    </div>`;
